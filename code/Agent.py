...
model = DQN("MlpPolicy", vec_env, verbose=0, seed=seed_value, tensorboard_log='../log/', learning_rate=2.5e-4,
            ...
            exploration_final_eps=0.05, exploration_fraction=0.6, train_freq=4, target_update_interval=1500,
...
# 训练模型
model.learn(total_timesteps=500000, callback=call_back, tb_log_name=training_time, log_interval=4, progress_bar=True)
