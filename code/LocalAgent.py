...
model = DQN("MlpPolicy", vec_env, verbose=0, seed=seed_value, tensorboard_log='../log/', learning_rate=2.5e-4,
            buffer_size=500000, gamma=0.99, tau=1.0, batch_size=128, learning_starts=50000,
            exploration_initial_eps=1,
            exploration_final_eps=0.05, exploration_fraction=0.2, train_freq=4, target_update_interval=1500,
...
# 训练模型
model.learn(total_timesteps=2000000, callback=call_back, tb_log_name=training_time, log_interval=4)
